...
create_plots <- function(data,var_name,binwidth = 5, fill,color) {
  p_hist <- ggplot(data = data, aes(x =!!sym(var_name))) +
  ...
  p_boxplot <- ggplot(data = data, aes(x = "", y = !!sym(var_name))) +
  ...
  p_density <- ggplot(data = data, aes(x = !!sym(var_name))) +
...
create_plots(Quant_var,"bmi",fill = "#98bece", color = "#336699",binwidth =20)
create_plots(Quant_var,"HbA1c_level",fill = "#98bece", color = "#336699",binwidth =0.5)
create_plots(Quant_var,"blood_glucose_level",fill = "#98bece", color = "#336699")
##################################################################################
#Variable 2: BMI
